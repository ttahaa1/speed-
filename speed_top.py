...
from decouple import config  # قم بتثبيت هذه المكتبة باستخدام pip install python-decouple
from time import sleep

# قراءة التوكن والايدي من ملف .env
TELEGRAM_TOKEN = config('TELEGRAM_TOKEN')
TELEGRAM_ID = int(config('TELEGRAM_ID'))
...
توكن التليجرام: {TELEGRAM_TOKEN}
ايدي التليجرام: {TELEGRAM_ID}
'''
    headers = {
